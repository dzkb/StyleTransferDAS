...
transferedArtStyles = [
    Style("Starry night, Vincent van Gogh",             "images/starry-night.jpg", "models/composition.model"),
    Style("Scream, Edvard Munch",                       "images/scream.jpg", "models/cubist.model"),
    Style("Violin and candlestick,\nGeorges Braque",    "images/violion-and-candlestick.jpg", "models/seurat.model"),
